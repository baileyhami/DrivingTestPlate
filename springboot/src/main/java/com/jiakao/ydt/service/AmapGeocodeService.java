...
public class AmapGeocodeService {
    ...
    static final String CACHE_UNLESS_EXPRESSION = "#result == null";

    private final IntegrationProperties integrationProperties;

    @Cacheable(cacheNames = RedisCacheConfig.AMAP_GEOCODE, key = "#address == null ? '' : #address.trim()", unless = CACHE_UNLESS_EXPRESSION)
