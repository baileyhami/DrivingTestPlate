...
public class AmapDirectionService {
    ...
    @Cacheable(cacheNames = RedisCacheConfig.AMAP_DIRECTION, key = "T(com.jiakao.ydt.service.AmapDirectionService).hashKey(#routePathJson)", unless = "#result == null || #result.planMode == 'ERROR'")
